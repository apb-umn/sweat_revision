...
if __name__ == '__main__':
    ...
    from parameters_newbench_chi_taubonly import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_chi_taubonly/'
    pickle_path = './save_data_newbench_chi_taubonly/econ_newbench_chi_taubonly.pickle'
    log_output_file = save_path + 'paras_mom_newbench_chi_taubonly50.txt'
