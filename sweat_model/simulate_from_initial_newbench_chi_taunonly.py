...
if __name__ == '__main__':
    ...
    from parameters_newbench_chi_taunonly import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_chi_taunonly/'
    pickle_path = './save_data_newbench_chi_taunonly/econ_newbench_chi_taunonly.pickle'
    log_output_file = save_path + 'paras_mom_newbench_chi_taunonly50.txt'
    ...
    initial_path = './save_data_newbench_chi/'
