...
if __name__ == '__main__':
    ...
    from parameters_newbench_chi import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_chi/'
    pickle_path = './save_data_newbench_chi/econ_newbench_chi.pickle'
    log_output_file = save_path + 'paras_mom_newbench_chi50.txt'
