...
### paths
save_data_folder='save_data_newbench_compliance_taubonly'

### number of cores utilize
num_core = 640 # number of cores for parallel

 
# prices <Anmol: updated using previous solution> 
p =  2.095775671996304
rc =  0.06835064085058322
...
GDP_guess = 3.0721554998488187 #a guess for GDP value. This needs to be consistent with simulated GDP
...
taubold = np.array([.14, .183, .201, .235, .262, .269, 0.280])
taubhigh= np.array([.293, .324, .343, .390, .40, .408, .419])
taubchangeold=taubold*(1.-.506)
taubhighchange=np.array([.293, .324, .343, .390, .40, .408, .419])*(1.-0.255)
taub=1-0.5*(1-taubchangeold)-0.5*(1-taubhighchange)
...
psib_fixed = 0.08 # value for the fixed intercept
...
# one intercept should be fixed
psin_fixed = 0.08 # value for the fixed intercept
