...
if __name__ == '__main__':
    ...
    from parameters_newbench_superstar import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_superstar/'
    pickle_path = './save_data_newbench_superstar/econ_newbench_superstar.pickle'
    log_output_file = save_path + 'paras_mom_newbench_superstar50.txt'
