...
if __name__ == '__main__':
    ...
    from parameters_newbench_taubtaup import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_taubtaup/'
    pickle_path = './save_data_newbench_taubtaup/econ_newbench_taubtaup.pickle'
    log_output_file = save_path + 'paras_mom_newbench_taubtaup50.txt'
