...
### paths
save_data_folder='save_data_newbench_taubtaup'

### number of cores utilize
num_core = 640 # number of cores for parallel

# prices <Anmol: guess using oconverged solution>
p  = 2.1721641774834057
rc = 0.059075625396797345
...
taub = np.array([.14, .183, .201, .235, .262, .269, 0.280])*(1.-.506)
