...
if __name__ == '__main__':
    ...
    from parameters_newbench_compliance import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_compliance/'
    pickle_path = './save_data_newbench_compliance/econ_newbench_compliance.pickle'
    log_output_file = save_path + 'paras_mom_newbench_compliance50.txt'
