...
if __name__ == '__main__':
    ...
    from parameters_newbench_superstar_taunonly import *
    # from parameters_taubonly import *
    # from parameters_taunonly import *    
    
    ### log file destination ###
    save_path = './save_data_newbench_superstar_taunonly/'
    pickle_path = './save_data_newbench_superstar_taunonly/econ_newbench_superstar_taunonly.pickle'
